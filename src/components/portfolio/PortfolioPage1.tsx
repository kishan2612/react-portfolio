...
const PortfolioPage1 = () => {
    return (
        ...
        style={{background:userKishan.primaryColor}}>
            ...
            <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 w-1/3">
            <img
            ...
            <div className="absolute bottom-0 left-0 px-16 pb-16 w-1/3">
                <p className="text-black text-base font-normal line-clamp-4">{userKishan.description}</p>
            </div>
